...
folder_path = script_path+'/log/us1/contact/'
dataframes = []
...
# combined_df['actuar_voltage_1'] = savgol_filter(combined_df['actuar_voltage_1'], 100000,2)
# combined_df.plot(x = 'Index',y='actuar_voltage_1')
avg_power_df_0 = df.actuar_voltage_0 * df.actuar_current_0
avg_power_df_1 = df.actuar_voltage_1 * df.actuar_current_1
avg_power_df_2 = df.actuar_voltage_2 * df.actuar_current_2
avg_power_df_3 = df.actuar_voltage_3 * df.actuar_current_3
avg_power_df_4 = df.actuar_voltage_4 * df.actuar_current_4
avg_power_df_5 = df.actuar_voltage_5 * df.actuar_current_5
avg_power_df_6 = df.actuar_voltage_6 * df.actuar_current_6
avg_torque_df_0 = savgol_filter(df['joint_torque_0'],1000,2)
avg_torque_df_1 = savgol_filter(df['joint_torque_1'],1000,2)
avg_torque_df_2 = savgol_filter(df['joint_torque_2'],1000,2)
avg_torque_df_3 = savgol_filter(df['joint_torque_3'],1000,2)
avg_torque_df_4 = savgol_filter(df['joint_torque_4'],1000,2)
avg_torque_df_5 = savgol_filter(df['joint_torque_5'],1000,2)
avg_torque_df_6 = savgol_filter(df['joint_torque_6'],1000,2)
plt.plot(df['Index'],avg_torque_df_0,label='joint 0')
plt.plot(df['Index'],avg_torque_df_1,label='joint 1')
plt.plot(df['Index'],avg_torque_df_2,label='joint 2')
plt.plot(df['Index'],avg_torque_df_3,label='joint 3')
plt.plot(df['Index'],avg_torque_df_4,label='joint 4')
plt.plot(df['Index'],avg_torque_df_5,label='joint 5')
plt.plot(df['Index'],avg_torque_df_6,label='joint 6')
plt.xlabel('Time step')
plt.ylabel('Average torque (N)')
plt.legend()
plt.title('Average torque during manipulation in contact case')
plt.grid(True)
plt.show()
# # actuar_voltage_6
