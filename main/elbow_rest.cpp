...
{   
    ...
    // double k_p_position_linear = 5;
    // double k_p_position_angular = 14;
    // double k_p_velocity_linear = 2;
    // double k_p_velocity_angular = 12;

    double k_p_position_linear = 12;
    double k_p_position_angular = 12;
    double k_p_velocity_linear = 15;
    double k_p_velocity_angular = 15;
    ...
    *eff_cmd = *eff_msr * -1;
    ...
    KDL::Twist goalVel(KDL::Vector(0.0, 0.0, 0), KDL::Vector(0.0, 0.0, 0.0));
    do{
        ...
        // distance_counter = distance_counter - 0.01;
        logger.logInfo("\nSTEP %d" , counter);
        logger.logInfo("beta: %s",beta);
        logger.logInfo("constraint torque: %s",constrain_torque);
        // logger.logInfo("currVel: %s",currVel);
